...
// 唤醒接口，防止伺服器休眠
app.post(`${process.env.REACT_APP_API}/wakeup`, (req, res) => {
    res.send('"ok!"');
});

// 創建新帳號
app.post(`${process.env.REACT_APP_API}/login`, async (req, res) => {
...
// 獲取玩家分數
app.get(`${process.env.REACT_APP_API}/getScore`, async (req, res) => {
...
// 更新玩家分數
app.post(`${process.env.REACT_APP_API}/updateScore`, async (req, res) => {
...
// 獲取排行榜
app.get(`${process.env.REACT_APP_API}/leaderboard`, async (req, res) => {
    try {
